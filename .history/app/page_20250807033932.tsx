...
export default function QassimTourismGame() {
  ...
  return (
    <main className="bg-white text-[#1B1F5C] font-sans">
      ...
      {/* 🔵 اسم اللعبة والزر داخل خلفية كحلي */}
      ...
      <footer className="bg-[#1B1F5C] text-white pt-12 pb-6 px-6 md:px-16 text-sm">
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    >
                      <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 
                               ...
                               0-1.359.538-1.359 1.248 0 .694.521 1.248 1.327 
                               1.248h.015zm4.908 8.212V9.359c0-.215.016-.43.08-.584.175-.43.572-.877 
                               1.24-.877.875 0 1.225.662 1.225 1.633v3.863h2.4V9.28c0-2.22-1.18-3.252-2.755-3.252-1.274 
                               0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 
                               1 .016-.025V6.17h-2.4c.03.7 0 7.224 0 7.224h2.4z" />
                    </svg>
                    anfal-alharbi1
                  </span>
                </li>
        ...
        <div className="text-center mt-8">
          <a
            ...
            className="inline-block bg-[#00B5B8] text-white font-bold px-6 py-3 rounded-full hover:bg-white hover:text-[#1B1F5C] transition"
          >
...
if (gameState === 'landing') {
  return (
    <main className="bg-white text-[#1B1F5C] font-sans">
      ...
      {/* 🔵 قسم عن اللعبة بخلفية كحلي ونص أزرق فاتح */}
      <section className="bg-[#1B1F5C] text-[#00B5B8] py-16 px-6 text-center max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold mb-3">عن اللعبة</h2>
