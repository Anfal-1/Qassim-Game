    ...
    <main className="bg-white text-[#1B1F5C] font-sans">
      ...
      <header className="py-6 flex justify-center">
        <div className="w-36 h-36 rounded-full overflow-hidden relative select-none pointer-events-none">
          <img
            ...
            style={{
              maskImage: 'radial-gradient(circle, rgba(0,0,0,1) 75%, transparent 100%)',
              WebkitMaskImage:
      ...
      <footer className="bg-[#1B1F5C] text-white pt-12 pb-6 px-6 md:px-16 text-sm">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start max-w-7xl mx-auto gap-10 md:gap-20">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center md:items-end text-center md:text-right">
            <img
              src="/Qassim1.jpg"
              alt="Qassim1 Logo"
              className="w-28 h-auto mb-4 opacity-30 pointer-events-none select-none"
              style={{
                maskImage: 'radial-gradient(circle, rgba(0,0,0,1) 70%, transparent 100%)',
                WebkitMaskImage:
                  'radial-gradient(circle, rgba(0,0,0,1) 70%, transparent 100%)',
            ...
            <p className="text-gray-300 leading-relaxed text-sm max-w-xs">
              جمعية Qassim1 تسعى للارتقاء بالمجتمع التقني من خلال مبادرات تعليمية
              مثل "الوجهة الضبابية"، لدعم التميز السياحي والتقني.
            </p>
          </div>
        ...
        <div className="mt-12 text-center">
          <p className="mb-3 text-gray-300 text-base">
            💡 هل لديك فكرة وتبحث عن من يطوّرها باحترافية؟
          </p>
          <a
            href="mailto:info@qassim1.org"
            className="inline-block bg-[#00B5B8] text-white px-6 py-2 rounded-lg hover:bg-[#009ca0] transition"
          >
            اطلب خدمة بناء موقع الآن
          </a>
        </div>
