...
import { MapPin, Star, Play, RotateCcw, Share2, Volume2, VolumeX, Home, Camera, Eye } from "lucide-react"
...
const landmarks = [
  ...
  },
  {
    ...
    options: ["البلدة القديمة", "البلدة التراثية في رياض الخبراء", "قرية الوادي"],
    correctAnswer: 1,
    difficulty: "صعب",
    points: 20,
  },
  {
    id: 12,
    name: "برج المياه التاريخي",
    image: "/images/historical-tower.jpeg",
    info: "معلم تاريخي مميز يعكس التراث المعماري لمنطقة القصيم ويعتبر من أبرز الرموز التراثية في بريدة، بُني في العهد السعودي الأول ويحتوي على خزانات مياه ضخمة",
    options: ["برج المياه التاريخي", "قصر الإمارة", "سوق المجلس"],
    correctAnswer: 0,
    difficulty: "سهل",
    points: 10,
  },
  ...
  },
  {
    ...
    name: "سوق المجلس",
    image: "/images/souq-musawkaf.jpeg",
    info: "أحد أقدم الأسواق النجدية، طوله يقارب 300 م، يُقام فيه كل جمعة حراج تقليدي، وكان مركزًا تجاريًّا اجتماعيًّا عبر التاريخ",
    options: ["سوق الذهب", "سوق المجلس", "سوق الخضار"],
    correctAnswer: 1,
    difficulty: "متوسط",
    points: 15,
  },
  {
    ...
    name: "جادة عسيب",
    image: "/images/ghada-reserve.jpeg",
    info: "جزء من مسار الشمال السياحي، تتميز بطابع ريفي حميم يحاكي الطبيعة وتشمل مقاهي وحدائق وأنشطة ترفيهية مع أجواء موسمية ممتعة",
    options: ["جادة الورد", "جادة عسيب", "جادة النور"],
    correctAnswer: 1,
    difficulty: "سهل",
    points: 10,
  },
  ...
  },
  {
    ...
    name: "مزرعة هضيم",
    image: "/images/ghada-reserve.jpeg",
    info: "تأسست عام 1992، وهي من أكبر مزارع التمور في القصيم، تعتمد تقنيات زراعية حديثة وتنتج أصنافًا محلية متنوعة، وتجذب الزوار للتجول والتعرف على الزراعة التراثية",
    options: ["مزرعة النخيل", "مزرعة هضيم", "مزرعة التمور"],
    correctAnswer: 1,
    difficulty: "متوسط",
    points: 15,
  },
  ...
  {
    id: 21,
    name: "متحف القصيم الإقليمي",
    image: "/images/regional-museum.jpeg",
    info: "يضم مجموعة نادرة من القطع الأثرية والتراثية التي تحكي تاريخ المنطقة العريق وثقافتها الأصيلة عبر العصور المختلفة، مع معروضات تفاعلية حديثة",
    options: ["مركز الملك عبدالعزيز", "متحف القصيم الإقليمي", "قصر البجيري"],
    correctAnswer: 1,
    difficulty: "متوسط",
    points: 15,
  },
  {
    ...
    image: "/images/ghada-reserve.jpeg",
    info: "أكبر الحدائق في المنطقة وتتميز بمساحاتها الخضراء الواسعة ومرافقها الترفيهية المتنوعة للعائلات مع بحيرات صناعية جميلة ومسارات للمشي والجري",
    options: ["حديقة الأمير فيصل", "حديقة الملك عبدالله", "منتزه السلام"],
    correctAnswer: 1,
    difficulty: "سهل",
    points: 10,
  },
  {
    id: 23,
    name: "قصر الإمارة التاريخي",
    image: "/images/beit-bassam.jpeg",
    info: "مبنى تاريخي يعكس العمارة التقليدية النجدية ويحتوي على قاعات للمناسبات الرسمية والتراثية مع تصاميم معمارية فريدة وزخارف إسلامية أصيلة",
    options: ["قصر الإمارة التاريخي", "قصر المربع", "قصر الحكم"],
    correctAnswer: 0,
    difficulty: "صعب",
    points: 20,
  },
...
export default function QassimTourismGame() {
  ...
  const finishGame = () => {
    ...
    const correctAnswers = shuffledLandmarks
      ...
      .filter((_, index) => selectedAnswer === shuffledLandmarks[index]?.correctAnswer).length
    ...
    const newStats = {
      ...
      averageTime: Math.round(
        (gameStats.averageTime * gameStats.totalGames + totalGameTime) / (gameStats.totalGames + 1),
      ),
    }
          ...
          <Card className="heritage-card shadow-2xl overflow-hidden animate-fade-in">
            <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
              ...
              <div className="card-gradient rounded-2xl p-4 lg:p-6 mb-6 lg:mb-8 text-right animate-slide-up border-2 foggy-gray-border">
                <h2 className="text-xl lg:text-2xl font-bold medium-brown-text mb-4 text-center">طريقة اللعب:</h2>
                <div className="grid md:grid-cols-3 gap-4 lg:gap-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="font-bold text-base lg:text-lg mb-2 medium-brown-text">شاهد الصورة</h3>
                    <p className="medium-brown-text text-sm lg:text-base">ستظهر لك صورة ضبابية لمعلم سياحي في القصيم</p>
                  </div>
                  <div className="flex flex-col items-center text-center">
                    <div className="w-12 h-12 lg:w-16 lg:h-16 dark-brown-bg rounded-full flex items-center justify-center text-white font-bold mb-3">
                      <Camera className="w-6 h-6 lg:w-8 lg:h-8" />
                    </div>
                    <h3 className="font-bold text-base lg:text-lg mb-2 medium-brown-text">اختر الإجابة</h3>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="font-bold text-base lg:text-lg mb-2 medium-brown-text">تعلم واستمتع</h3>
                    <p className="medium-brown-text text-sm lg:text-base">
                ...
                <div className="flex justify-center gap-4">
                  <Button
                    onClick={() => {
                      ...
                      if (typeof window !== "undefined") {
                        localStorage.setItem("qassim-game-sound", JSON.stringify(!soundEnabled))
                      }
                    }}
                    variant="outline"
                    size="lg"
  ...
  if (gameState === "playing") {
    const progress = ((currentLandmarkIndex + 1) / shuffledLandmarks.length) * 100
            ...
            <CardContent className="p-0">
              ...
              <div className="relative overflow-hidden">
                <img
                  ...
                  alt="معلم سياحي"
                  className={`w-full h-48 sm:h-64 lg:h-80 object-cover transition-all duration-1200 ${
              ...
              <div className="p-4 lg:p-6">
                ...
                {showResult && (
                  ...
                  >
                    ...
                    <h3 className="text-lg lg:text-2xl font-bold mb-3 medium-brown-text">{currentLandmark.name}</h3>
                    <p className="text-sm lg:text-base leading-relaxed mb-3 medium-brown-text">
                      {currentLandmark.info}
                    </p>
                    {isCorrect && (
                      <div className="flex flex-wrap justify-center gap-2 text-sm">
                        <Badge variant="secondary" className="px-2 py-1 bg-foggy-gray medium-brown-text">
                          نقاط الصعوبة: {currentLandmark.points}
                        </Badge>
                        <Badge variant="secondary" className="px-2 py-1 bg-green-100 text-green-800">
                ...
                {showResult && (
                  <div className="text-center mt-4 lg:mt-6">
                    ...
                    >
                      {currentLandmarkIndex < shuffledLandmarks.length - 1 ? "السؤال التالي" : "عرض النتائج"}
  ...
  if (gameState === "finished") {
    const maxPossibleScore = shuffledLandmarks.reduce((sum, landmark) => sum + landmark.points + 10, 0)
        ...
        <Card className="max-w-4xl w-full heritage-card shadow-2xl animate-bounce-in">
          <CardContent className="p-4 sm:p-6 lg:p-8 text-center">
            <div className="mb-6 lg:mb-8">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold gradient-text mb-3">انتهت اللعبة!</h1>
            </div>

            <div className={`${bgColor} rounded-2xl p-4 lg:p-6 mb-6 border-2 foggy-gray-border`}>
              <div className="text-4xl lg:text-6xl font-bold medium-brown-text mb-3">{score}</div>
              <div className="text-xl lg:text-2xl font-bold medium-brown-text mb-3">نقطة</div>
              <div className="text-lg lg:text-xl font-bold medium-brown-text mb-3">{percentage}%</div>
              <p className="text-base lg:text-lg medium-brown-text font-semibold">{message}</p>
            </div>

            {/* إحصائيات اللعبة */}
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 mb-6 lg:mb-8">
              <div className="heritage-card rounded-xl p-3 lg:p-4 border-2 foggy-gray-border">
                <div className="text-xl lg:text-2xl font-bold medium-brown-text">{currentLandmarkIndex + 1}</div>
                <div className="medium-brown-text font-semibold text-xs lg:text-sm">أسئلة مجابة</div>
              </div>
              <div className="heritage-card rounded-xl p-3 lg:p-4 border-2 border-green-200">
                <div className="text-xl lg:text-2xl font-bold text-green-800">{correctAnswers}</div>
                <div className="text-green-600 font-semibold text-xs lg:text-sm">إجابات صحيحة</div>
              </div>
              <div className="heritage-card rounded-xl p-3 lg:p-4 border-2 border-blue-200">
                <div className="text-xl lg:text-2xl font-bold text-blue-800">{Math.round(totalTimeTaken / 1000)}ث</div>
                <div className="text-blue-600 font-semibold text-xs lg:text-sm">إجمالي الوقت</div>
              </div>
              <div className="heritage-card rounded-xl p-3 lg:p-4 border-2 border-purple-200">
                ...
                <div className="text-purple-600 font-semibold text-xs lg:text-sm">أفضل نتيجة</div>
              </div>
            </div>
