    ...
    <main className="bg-white text-[#1B1F5C]">
      ...
      <section className="py-16 px-6 text-center max-w-2xl mx-auto">
        ...
        <p className="text-gray-700 leading-relaxed">
          "الوجهة الضبابية" هي لعبة تفاعلية تعليمية تهدف لتعزيز المعرفة السياحية والثقافية
          عن منطقة القصيم، من خلال استكشاف صور مغبشة لمعالم المنطقة بطريقة ممتعة وتنافسية.
        </p>
      </section>

      {/* 🟦 Footer رسمي كحلي */}
      <footer className="bg-[#1B1F5C] text-white py-10 px-6 text-center">
        <img
          src="/logo.png"
          alt="Qassim Tech Logo"
          className="w-24 h-auto mx-auto mb-4"
        />
        <p className="max-w-md mx-auto text-sm leading-relaxed text-gray-300">
          تتطلع جمعية Qassim1 إلى تعزيز التميز في المجال التقني، ورفع مستوى الوعي والقدرات الرقمية
          من خلال مبادرات تعليمية مبتكرة مثل "الوجهة الضبابية".
        </p>
        <p className="mt-4 text-xs text-gray-400">© جميع الحقوق محفوظة 2025</p>
      </footer>
    </main>
  );
}
