      ...
      <main className="bg-white text-[#1B1F5C] font-sans">
        ...
        <section className="bg-[#1B1F5C] text-white flex flex-col items-center justify-center text-center py-24 px-6">
          ...
          <button
            ...
            className="bg-[#00B5B8] text-white font-semibold px-8 py-3 rounded-full hover:bg-[#008B94] transition shadow-lg"
          >
            ابدأ اللعبة
          </button>
        </section>
        ...
        <footer className="bg-[#1B1F5C] text-white pt-12 pb-6 px-6 md:px-16 text-sm">
                ...
                <ul className="space-y-2 text-gray-200">
                  <li>
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-[#00B5B8] text-white font-semibold px-4 py-2 rounded-full hover:bg-[#008B94] transition"
                    >
                      {/* أيقونة LinkedIn */}
                      <svg
          ...
          <div className="text-center mt-8">
            <a
              ...
              className="inline-block bg-[#00B5B8] text-white font-bold px-6 py-3 rounded-full hover:bg-[#008B94] transition"
            >
