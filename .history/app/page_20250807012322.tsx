...
export default function QassimTourismGame() {
  ...
  if (gameState === 'landing') {
    return (
      <main className="bg-white text-[#1B1F5C]">
        {/* 🟦 الشعار في الأعلى */}
        ...
        {/* 🟦 القسم الرئيسي بخلفية أو صورة */}
        <section
          className="bg-cover bg-center text-white flex flex-col items-center justify-center text-center py-24 px-6"
          style={{
            backgroundImage: 'url(/cover.jpg)', // يمكنك استبداله بلون كحلي
            backgroundColor: '#1B1F5C', // fallback color
          }}
        >
        ...
        <footer className="bg-[#1B1F5C] text-white pt-12 pb-6 px-4 md:px-10 text-sm">
  {/* شعار + وصف */}
  <div className="text-center mb-10">
    <img src="/logo.png" alt="Qassim1 Logo" className="w-24 h-auto mx-auto mb-4" />
    <p className="max-w-xl mx-auto text-gray-300 leading-relaxed">
      تسعى جمعية Qassim1 إلى تمكين المجتمع التقني في منطقة القصيم عبر مبادرات تعليمية مبتكرة مثل "الوجهة الضبابية"، لرفع الوعي السياحي والتقني بطريقة تفاعلية ممتعة.
    </p>
  </div>

  {/* شبكة مقسومة لجزأين */}
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto text-center md:text-start">
    
    {/* فريق العمل */}
    <div>
      <h3 className="text-[#00B5B8] font-semibold mb-2">فريق العمل</h3>
    ...
    {/* تواصل معنا */}
    <div>
      <h3 className="text-[#00B5B8] font-semibold mb-2">تواصل معنا</h3>
      <ul className="space-y-1 text-gray-200">
        <li>
          📧 <a href="mailto:info@qassim1.org" className="hover:underline">info@qassim1.org</a>
        </li>
        <li>
          🔗 <a href="https://qassim.tech" target="_blank" rel="noreferrer" className="hover:underline">qassim.tech</a>
        </li>
      </ul>
    </div>
  </div>
