...
export default function QassimTourismGame() {
  ...
  <p className="max-w-md mx-auto text-sm leading-relaxed text-gray-300">
    تتطلع جمعية Qassim1 إلى تعزيز التميز في المجال التقني، ورفع مستوى الوعي
    والقدرات الرقمية من خلال مبادرات تعليمية مبتكرة مثل "الوجهة الضبابية".
  </p>
  ...
  {/* حقوق النشر */}
  <p className="mt-6 text-xs text-gray-400">© جميع الحقوق محفوظة 2025</p>
</footer>
