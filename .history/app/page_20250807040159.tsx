...
export default function QassimTourismGame() {
  ...
  if (gameState === 'landing') {
    return (
      <main className="bg-white text-[#1B1F5C] font-sans">
        ...
        {/* 🔵 قسم عن اللعبة */}
        <section className=" bg-[#1B1F5C] py-16 px-6 text-center max-w-2xl mx-auto">
 ...
 {/* 🔵 القسم الرئيسي بخلفية كحلي */}
        <section className=" text-white flex flex-col items-center justify-center text-center py-24 px-6">
          ...
          <button
            ...
            className="bg-[#00B5B8]  text-[#1B1F5C] font-semibold px-8 py-3 rounded-full hover:scale-105 transition shadow-lg"
          >
            ابدأ اللعبة
          </button>
        </section> 
