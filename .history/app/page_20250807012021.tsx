        ...
        <footer className="bg-[#1B1F5C] text-white pt-12 pb-6 px-4 md:px-10 text-sm">
          ...
          <div className="text-center mb-10">
            ...
            <p className="max-w-xl mx-auto text-gray-300 leading-relaxed">
              تسعى جمعية Qassim1 إلى تمكين المجتمع التقني في منطقة القصيم عبر
              مبادرات تعليمية مبتكرة مثل "الوجهة الضبابية"، لرفع الوعي السياحي
              والتقني بطريقة تفاعلية ممتعة.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto text-center md:text-start">
            ...
            <div>
              ...
              <ul className="space-y-1 text-gray-200">
                <li>
                  📧{' '}
                  <a href="mailto:info@qassim1.org" className="hover:underline">
                    info@qassim1.org
                  </a>
                </li>
                <li>
